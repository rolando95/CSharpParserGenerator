    ...
    public class MyQueryParser
    {
        ...
        private Parser<ELang> CompileParser()
        {
            ...
            var rules = new SyntaxDefinition<ELang>(new Dictionary<ELang, DefinitionRules>()
            {
                ...
                {
                    new List<Token> { ELang.LogicalOr, ELang.Or, ELang.LogicalAnd, new Op(o => o[0] = new MyExpressionTree() { Operation = ELang.Or, Left = o[0], Right = o[2] }) },
                    new List<Token> { ELang.LogicalAnd }
                },
                [ELang.LogicalAnd] = new DefinitionRules
                {
                    new List<Token> { ELang.LogicalAnd, ELang.And, ELang.Relational, new Op(o => o[0] = new MyExpressionTree() { Operation = ELang.And, Left = o[0], Right = o[2] }) },
                    new List<Token> { ELang.Relational }
                },
                [ELang.Relational] = new DefinitionRules
                {
                    new List<Token> { ELang.Property, ELang.Eq, ELang.Term, new Op(o => o[0] = new MyExpressionTree() { Property = o[0], Operation = ELang.Eq, Value = o[2] }) },
                    new List<Token> { ELang.Property, ELang.Neq, ELang.Term, new Op(o => o[0] = new MyExpressionTree() { Property = o[0], Operation = ELang.Neq, Value = o[2] }) },

                    new List<Token> { ELang.Property, ELang.Gt, ELang.Term, new Op(o => o[0] = new MyExpressionTree() { Property = o[0], Operation = ELang.Gt, Value = o[2] }) },
                    new List<Token> { ELang.Property, ELang.Lt, ELang.Term, new Op(o => o[0] = new MyExpressionTree() { Property = o[0], Operation = ELang.Lt, Value = o[2] }) },

                    new List<Token> { ELang.Property, ELang.Gte, ELang.Term, new Op(o => o[0] = new MyExpressionTree() { Property = o[0], Operation = ELang.Gte, Value = o[2] }) },
                    new List<Token> { ELang.Property, ELang.Lte, ELang.Term, new Op(o => o[0] = new MyExpressionTree() { Property = o[0], Operation = ELang.Lte, Value = o[2] }) },

                    new List<Token> { ELang.LParenthesis, ELang.Expression, ELang.RParenthesis, new Op(o => { o[0] = o[1]; }) },
                },
                [ELang.Term] = new DefinitionRules
                {
                    new List<Token> { ELang.Number, new Op(o => { o[0] = Convert.ToDouble(o[0]); }) },
                    new List<Token> { ELang.Boolean, new Op(o => { o[0] = Convert.ToBoolean(o[0]); }) },
                    new List<Token> { ELang.String, new Op(o => { o[0] = (o[0] as String)[1..^1]; }) },
                }
            });
